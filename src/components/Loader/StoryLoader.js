...
const StoryLoader = () => {
  return (
    <div className="mb-16 md:mb-20">
      <div
        role="status"
        className="space-y-8 animate-pulse space-y-0 space-x-8 rtl:space-x-reverse flex items-center mb-6">
        <div className="flex items-center justify-center w-full h-20 md:h-24 bg-gray-300 rounded w-32 md:w-48">
          <svg
